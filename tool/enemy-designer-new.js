...
function bindEnemyIntegerInputs() {
    DesignerBase.bindIntegerInputs([
        { id: 'enemyStrength', allowNegative: true },
        { id: 'enemyStamina', allowNegative: true },
        { id: 'enemyAgility', allowNegative: true },
        { id: 'enemyLuck', allowNegative: true },
        { id: 'enemyArmor', allowNegative: true },
        { id: 'enemyMinDamage', allowNegative: true },
        { id: 'enemyMaxDamage', allowNegative: true }
    ]);
}
...
function getEnemyAssetGallery() {
    ...
    enemyAssetGallery = DesignerBase.createAssetGallery('enemy', {
        ...
        onUploaded: ({ result, base64Data, gallery }) => {
            ...
            if (typeof upsertGlobalRecord === 'function') {
                upsertGlobalRecord('enemyAssets', newAsset, ['assetID', 'id']);
                enemyAssets = getEnemyAssets();
            } else {
